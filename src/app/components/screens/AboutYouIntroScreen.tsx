  ...
  return (
    ...
    >
      <div
        ...
        style={{ animation: 'PhaseFlow-fade-in 0.55s ease-out both' }}
      />
      <div
        className="absolute -bottom-10 -left-14 w-52 h-52 rounded-full bg-[var(--PhaseFlow-sage)]/12 pointer-events-none"
        style={{ animation: 'PhaseFlow-fade-in 0.7s ease-out both' }}
      />

      <div className="flex-1 flex flex-col justify-center relative z-10">
        <h1
          className="mb-3 font-['DM_Sans'] text-[var(--PhaseFlow-text-primary)]"
          style={{ animation: 'PhaseFlow-fade-up 0.45s ease-out both' }}
        >
          Hi {userName}, let&apos;s get to know about you!
        </h1>
        <p
          className="font-['DM_Sans'] text-[var(--PhaseFlow-text-secondary)]"
          style={{ animation: 'PhaseFlow-fade-up 0.62s ease-out both' }}
        >
