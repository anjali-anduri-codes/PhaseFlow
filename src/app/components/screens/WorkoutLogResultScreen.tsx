  ...
  return (
    <div className="flex flex-col h-full p-6 pt-12">
      ...
      <div className="flex-1 space-y-4">
        <div className="px-4 py-3 rounded-xl bg-gray-100 text-[var(--PhaseFlow-text-secondary)]">
          <p>{logText || 'No workout note provided.'}</p>
        </div>

        <div className="p-4 bg-[var(--PhaseFlow-off-white)] rounded-xl border-2 border-[var(--phase-ovulatory)]">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              <span className="text-sm text-[var(--PhaseFlow-text-secondary)]">Energy</span>
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              <span className="text-sm text-[var(--PhaseFlow-text-secondary)]">Completion</span>
            ...
            <div className="flex justify-between items-center py-2">
              <span className="text-sm text-[var(--PhaseFlow-text-secondary)]">Mood</span>
              <span>{displayAnalysis ? displayAnalysis.mood : 'Unavailable'}</span>
            </div>
          </div>

          <div className="mt-4 p-3 bg-white rounded-lg">
            <h4 className="text-sm mb-1">What PhaseFlow will adjust</h4>
